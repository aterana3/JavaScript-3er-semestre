...
//node ANTHONY_EMILIANO_TERÁN_ARELLANO_TLL5_5.js
...
const archivo = "./archivos/Archivo190523_05.txt";
...
if (existeRutaPadre) {
    ...
    if (existeArchivo) {
        ...
        fs.readFile(archivo, 'utf-8', (err, data) => {
            if (err) console.log(`Error en el sistema: ${err}`);
            console.log(data);
        });
    } else {
        ...
        fs.writeFile(archivo, contenido, 'utf-8', (err) => {
            if (err) console.log(`No se puede crear el achivo: ${err}`);
